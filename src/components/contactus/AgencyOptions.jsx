...
export default function AgencyOptions() {
  ...
  return (
    <>
      ...
      <div
        id="get-quote"
        className="min-h-screen flex flex-col items-center justify-center w-full bg-[#071119] text-white p-4"
      >
        <h1 className="text-3xl font-bold mb-6 text-[#00FF9D]">Let's Talk</h1>

        {!showForm ? (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl w-full">
            <div className="bg-[#071119] border border-[#00FF9D] rounded-lg p-6 flex flex-col">
              <h2 className="text-2xl font-bold mb-2 text-[#00FF9D]">
                Onboarding Form
              </h2>
              ...
              <div className="flex-grow">
                <p className="mb-2">
                  Our onboarding form covers all the essential details we need
                  to understand your project. It includes sections on:
                </p>
            ...
            <div className="bg-[#071119] border border-[#00FF9D] rounded-lg p-6 flex flex-col">
              <h2 className="text-2xl font-bold mb-2 text-[#00FF9D]">Book a Call</h2>
              <p className="text-white/70 mb-4">
            ...
            <div className="bg-[#071119] border border-[#00FF9D] rounded-lg p-6 max-w-md w-full">
              ...
              <div className="mb-4">
                ...
                <input
                  type="date"
                  id="date"
                  className="w-full bg-[#071119] border border-white text-white rounded-md p-2 "
              ...
              <div className="mb-4">
                ...
                <input
                  type="email"
                  id="email"
                  className="w-full bg-[#071119] border border-white rounded-md p-2 text-white"
                />
              </div>

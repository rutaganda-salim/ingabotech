...
export default function HeroSection() {
    return (
        <div className="bg-[#071119] text-white py-8 sm:py-12 md:py-16 px-4 flex flex-col min-h-screen">
            <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-base sm:text-lg md:text-xl text-gray-300 mb-6 sm:mb-8">
                    We specialize in creating tailored software solutions and providing strategic tech consulting to help your business thrive online. Enhance your digital impact with our expert SEO optimization services.
                </p>
                <button className="bg-[#00ff9d] text-[#0c0d0e] px-8 sm:px-12 py-3 sm:py-4 rounded-full font-medium border-2 border-[#00ff9d] hover:bg-[#071119] hover:text-white hover:border-[#00cc7d] transition-colors duration-300 ease-in-out w-full sm:w-auto">
                    Quote now
                </button>
            ...
            <div className="mt-8 sm:mt-12 md:mt-16">
                <p className="text-center text-gray-400 mb-4 sm:mb-6">Companies that trust Ingabo Tech</p>

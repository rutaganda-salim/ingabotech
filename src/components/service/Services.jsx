...
const ServiceCard = ({ icon: Icon, title, description }) => (
  <div className="bg-[#0c1824] p-6 md:p-8 rounded-lg shadow-2xl hover:shadow-3xl transition-all duration-300 ease-in-out transform hover:-translate-y-3 hover:bg-[#0f1f2e] group w-full">
    <div className="flex items-center mb-4 md:mb-6">
      <div className="bg-[#004d29] rounded-full p-3 md:p-4 mr-4 group-hover:bg-[#00ff9d] transition-colors duration-300">
        <Icon className="w-6 h-6 md:w-8 md:h-8 text-[#00ff9d] group-hover:text-[#0c1824] transition-colors duration-300" />
      </div>
      <h3 className="text-[#00ff9d] text-xl md:text-2xl font-semibold group-hover:text-white transition-colors duration-300">{title}</h3>
    </div>
    <p className="text-gray-300 text-sm md:text-base group-hover:text-[#00ff9d] transition-colors duration-300">{description}</p>
  </div>
);
...
const ServicesSection = () => {
  ...
  return (
    <section id='services' className="bg-[#071119] py-16 px-4 md:py-20 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-3xl md:text-4xl font-bold text-white text-center mb-6 md:mb-8">Our Services</h2>
        <p className="text-gray-300 text-center max-w-2xl mx-auto mb-8 md:mb-12 text-base md:text-lg">
